...
type ServerInterface interface {
	...
	// (PUT /product/create/{productId})
	CreateProduct(w http.ResponseWriter, r *http.Request, productId string)
}
...
func (siw *ServerInterfaceWrapper) CreateProduct(w http.ResponseWriter, r *http.Request) {
	...
	var handler = func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.CreateProduct(w, r, productId)
	}
...
func HandlerWithOptions(si ServerInterface, options ChiServerOptions) http.Handler {
	...
	r.Group(func(r chi.Router) {
		r.Put(options.BaseURL+"/product/create/{productId}", wrapper.CreateProduct)
	})
